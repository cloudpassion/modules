...
class DefaultDjangoORM:
    ...
    hash_strings = {
        ...
        # MergedTelegramUser.hash_key: USER_KEYS,
        # MergedTelegramChat.hash_key: CHAT_KEYS,
        # MergedTelegramMessage.hash_key: MESSAGE_KEYS,
        # 'ForwardedToDiscuss': [
    ...
    async def create(self, host, database, user, password, port):
