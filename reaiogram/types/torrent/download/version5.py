...
class TorrentDownloadVersion5(
    DefaultTorrent,
    AbstractMergedTelegram
):

    # pieces pack at once. size don't exceed 20MB
    async def _download_some_pieces_version5(self):
        ...
        asyncio.create_task(
            self._mon_completed_and_upload_version5(
                missing_pieces,
            )
        )
    ...
    async def _mon_completed_and_upload_version5(
            self,
            # torrent_pieces,
            missing_pieces,
    ):
        ...
        while missing_pieces:
            ...
            while True:
                ...
                if size + length + len(text) >= 20971520:
            ...
            tm_start = time.time()
            asyncio.create_task(
                self._mon_upload_task_version5(
                    pieces_to_upload,
                    hashes,
                    # data,
                    text,
    ...
    async def _mon_upload_task_version5(
            self,
            pieces_to_upload,
            hashes,
            text,
        ...
        caption = f'{self.info_hash}_{pieces_to_upload[0].info_hash}'
