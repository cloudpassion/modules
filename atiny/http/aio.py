...
class MergeResp:
    def __init__(
            ...
            error=True, proxy=None, path=None, request_headers={}, log=''):
...
class MyHttp:
    ...
    async def do(self, method, url, headers={}, data={}, path=None, tmp_dir='.tmp/'):
    ...
    async def _post(self, url, data={}, headers={}, **kwargs):
