...
async def print_progress_to_tmp_file(torrent, trackers, info_hash='unknow'):
    ...
    try:
        while True:
            line = f'{progress_template.format(total - torrent.missing_pieces)}' + \
